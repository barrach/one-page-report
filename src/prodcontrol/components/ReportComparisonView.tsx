...
import { CANONICAL_ORDER_FULL } from "@prodcontrol/lib/chartConstants";
import { normalizeToHundred } from "@prodcontrol/lib/hourlyAverageCalc";
import { generateComparisonPDF } from "@prodcontrol/lib/comparisonReportPdf";
