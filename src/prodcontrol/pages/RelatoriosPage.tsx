...
import { RadioGroup, RadioGroupItem } from "@prodcontrol/components/ui/radio-group";
...
} from "@prodcontrol/lib/chartConstants";
...
import { applyManualAdjustments, applyDbWeighting } from "@prodcontrol/lib/manualAdjustments";
import {
  StackedBarChartSection, ParetoChartSection, ExternalPieSection,
} from "@prodcontrol/components/ReportCharts";
import { generateSavedReportPDF } from "@prodcontrol/lib/savedReportPdf";
import { captureSavedReportCharts } from "@prodcontrol/lib/savedReportChartCapture";
import type { SavedReport } from "@prodcontrol/components/SavedReportsList";
    ...
    <AppLayout>
      <div className="max-w-5xl mx-auto">
        <div className="mb-6 flex items-center justify-between">
          ...
          <Button onClick={() => navigate("/prodcontrol/relatorios-salvos")} className="gap-2">
