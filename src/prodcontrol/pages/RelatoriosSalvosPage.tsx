...
import SavedReportView from "@prodcontrol/components/SavedReportView";
import ReportComparisonView from "@prodcontrol/components/ReportComparisonView";
...
import { calculateSavedReportExternalCauses } from "@prodcontrol/lib/savedReportExternalCauses";
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="sm" onClick={() => navigate("/prodcontrol/relatorios")} className="gap-1.5">
