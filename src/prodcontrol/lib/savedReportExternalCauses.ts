...
import { canonicalDescription } from "@prodcontrol/lib/chartConstants";
import { computeHHMedioDia, getRecordHHWithContext, normalizeToHundred } from "@prodcontrol/lib/hourlyAverageCalc";
