...
// Usa o cliente Supabase PRINCIPAL (VITE_SUPABASE_URL + VITE_SUPABASE_PUBLISHABLE_KEY,
// projeto bxmvzxtbjxlicjaewvfg) — onde os usuários do MegaHub (ex.: michel.zabalia)
